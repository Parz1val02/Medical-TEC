...
CREATE TABLE `historialmedico` (
  ...
  KEY `fk_historialmedico_seguros1_idx` (`seguros_id_seguro`),
  KEY `fk_historialmedico_cuestionario1_idx` (`cuestionario_idcuestionario`),
  CONSTRAINT `fk_historialmedico_cuestionario1` FOREIGN KEY (`cuestionario_idcuestionario`) REFERENCES `cuestionario` (`idcuestionario`),
  CONSTRAINT `fk_historialmedico_seguros1` FOREIGN KEY (`seguros_id_seguro`) REFERENCES `seguros` (`id_seguro`)
...
INSERT INTO `historialmedico` VALUES (1,'Alergia al Polen','Rehabilitacion',1,2,1);
