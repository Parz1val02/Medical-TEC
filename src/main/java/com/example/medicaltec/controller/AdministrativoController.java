                    ...
                    try {
                        correoConEstilos.sendEmailEstilos(correo,"Receta validada",
                                "<!DOCTYPE html>\n" +
                                        ...
                                        "                <h1 style=\"margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;\">Bienvenido a la plataforma de Medical-TEC!</h1>\n" +
                                        "                <p style=\"margin:0;\"> CITA VALIDADA <a href=\"http://www.example.com/\" style=\"color:#e50d70;text-decoration:underline;\"></a></p>\n" +
                                        " <p style=\"margin:0;\"> Estimado usuario, su pago de receta ha sido validado   </p> " +
                                        "              </td>\n" +
                                        "            </tr>\n" +
                                        "            <tr>\n" +
                                        "              <td style=\"padding:0;font-size:24px;line-height:28px;font-weight:bold;\">\n" +
                            ...
                            try {
                                correoConEstilos.sendEmailEstilos(usuarioSession.getEmail(),"Cita cancelada",
                                        "<!DOCTYPE html>\n" +
                                                ...
                                                "              <td style=\"padding:30px;background-color:#ffffff;\">\n" +
                                                "                <h1 style=\"margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;\">Bienvenido a la plataforma de Medical-TEC!</h1>\n" +
                                                "                <p style=\"margin:0;\"> CITA CANCELADA <a href=\"http://www.example.com/\" style=\"color:#e50d70;text-decoration:underline;\"></a></p>\n" +
                                                " <p style=\"margin:0;\">  Su consulta médica agendada para la fecha  "+citaA.getFecha() +" en la especialidad "+ citaA.getEspecialidadesIdEspecialidad().getNombreEspecialidad() + ", fue cancelada \n"+
                                                "              </td>\n" +
                                                "            </tr>\n" +
                                                "            <tr>\n" +
                                                "              <td style=\"padding:0;font-size:24px;line-height:28px;font-weight:bold;\">\n" +
                            ...
                            try {
                                correoConEstilos.sendEmailEstilos(usuarioSession.getEmail(),"Cita cancelada",
                                        "<!DOCTYPE html>\n" +
                                                ...
                                                "                <h1 style=\"margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;\">Bienvenido a la plataforma de Medical-TEC!</h1>\n" +
                                                "                <p style=\"margin:0;\"> CITA VALIDADA <a href=\"http://www.example.com/\" style=\"color:#e50d70;text-decoration:underline;\"></a></p>\n" +
                                                " <p style=\"margin:0;\"> Su examen médico agendado para la fecha  "+citaA.getFecha() +" en la especialidad "+ citaA.getExamenMedico().getNombre() + ", fue cancelado \n"+
                                                "              </td>\n" +
                                                "            </tr>\n" +
                                                "            <tr>\n" +
                                                "              <td style=\"padding:0;font-size:24px;line-height:28px;font-weight:bold;\">\n" +
